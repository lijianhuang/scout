...
struct OdomInfo_
{
  ...
  _localBundleIds_type localBundleIds;
   ...
   typedef std::vector< ::sensor_msgs::CameraInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_msgs::CameraInfo_<ContainerAllocator> >::other >  _localBundleModels_type;
  _localBundleModels_type localBundleModels;

   typedef std::vector< ::geometry_msgs::Transform_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Transform_<ContainerAllocator> >::other >  _localBundleModelTransforms_type;
