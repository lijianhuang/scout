...
(cl:defmethod cl:initialize-instance :after ((m <GlobalBundleAdjustment-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalBundleAdjustment-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<GlobalBundleAdjustment-request> is deprecated: use rtabmap_ros-srv:GlobalBundleAdjustment-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <GlobalBundleAdjustment-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:type-val is deprecated.  Use rtabmap_ros-srv:type instead.")
  (type m))
...
(cl:defmethod pixel_variance-val ((m <GlobalBundleAdjustment-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:pixel_variance-val is deprecated.  Use rtabmap_ros-srv:pixel_variance instead.")
  (pixel_variance m))

(cl:ensure-generic-function 'voc_matches-val :lambda-list '(m))
(cl:defmethod voc_matches-val ((m <GlobalBundleAdjustment-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:voc_matches-val is deprecated.  Use rtabmap_ros-srv:voc_matches instead.")
  (voc_matches m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalBundleAdjustment-request>)))
  ...
  "rtabmap_ros/GlobalBundleAdjustmentRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalBundleAdjustment-request)))
  "Returns string type for a service object of type 'GlobalBundleAdjustment-request"
  "rtabmap_ros/GlobalBundleAdjustmentRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GlobalBundleAdjustment-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalBundleAdjustment-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<GlobalBundleAdjustment-response> is deprecated: use rtabmap_ros-srv:GlobalBundleAdjustment-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalBundleAdjustment-response>)))
  ...
  "rtabmap_ros/GlobalBundleAdjustmentResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalBundleAdjustment-response)))
  "Returns string type for a service object of type 'GlobalBundleAdjustment-response"
  "rtabmap_ros/GlobalBundleAdjustmentResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalBundleAdjustment)))
  ...
  "rtabmap_ros/GlobalBundleAdjustment")