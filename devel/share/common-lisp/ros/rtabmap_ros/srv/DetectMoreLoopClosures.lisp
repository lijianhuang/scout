...
(cl:defmethod cl:initialize-instance :after ((m <DetectMoreLoopClosures-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectMoreLoopClosures-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<DetectMoreLoopClosures-request> is deprecated: use rtabmap_ros-srv:DetectMoreLoopClosures-request instead.")))
...
(cl:defmethod cluster_radius_max-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:cluster_radius_max-val is deprecated.  Use rtabmap_ros-srv:cluster_radius_max instead.")
...
(cl:defmethod cluster_radius_min-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:cluster_radius_min-val is deprecated.  Use rtabmap_ros-srv:cluster_radius_min instead.")
...
(cl:defmethod cluster_angle-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:cluster_angle-val is deprecated.  Use rtabmap_ros-srv:cluster_angle instead.")
  (cluster_angle m))

(cl:ensure-generic-function 'iterations-val :lambda-list '(m))
(cl:defmethod iterations-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:iterations-val is deprecated.  Use rtabmap_ros-srv:iterations instead.")
  (iterations m))

(cl:ensure-generic-function 'intra_only-val :lambda-list '(m))
(cl:defmethod intra_only-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:intra_only-val is deprecated.  Use rtabmap_ros-srv:intra_only instead.")
  (intra_only m))

(cl:ensure-generic-function 'inter_only-val :lambda-list '(m))
(cl:defmethod inter_only-val ((m <DetectMoreLoopClosures-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:inter_only-val is deprecated.  Use rtabmap_ros-srv:inter_only instead.")
  (inter_only m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectMoreLoopClosures-request>)))
  ...
  "rtabmap_ros/DetectMoreLoopClosuresRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectMoreLoopClosures-request)))
  "Returns string type for a service object of type 'DetectMoreLoopClosures-request"
  "rtabmap_ros/DetectMoreLoopClosuresRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DetectMoreLoopClosures-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectMoreLoopClosures-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<DetectMoreLoopClosures-response> is deprecated: use rtabmap_ros-srv:DetectMoreLoopClosures-response instead.")))

(cl:ensure-generic-function 'detected-val :lambda-list '(m))
(cl:defmethod detected-val ((m <DetectMoreLoopClosures-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:detected-val is deprecated.  Use rtabmap_ros-srv:detected instead.")
  (detected m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectMoreLoopClosures-response>)))
  ...
  "rtabmap_ros/DetectMoreLoopClosuresResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectMoreLoopClosures-response)))
  "Returns string type for a service object of type 'DetectMoreLoopClosures-response"
  "rtabmap_ros/DetectMoreLoopClosuresResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectMoreLoopClosures)))
  ...
  "rtabmap_ros/DetectMoreLoopClosures")